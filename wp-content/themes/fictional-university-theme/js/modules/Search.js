...
class Search
{
    ...
    { 
        $.getJSON(universityData.root_url + '/wp-json/university/v1/search?term=' + this.searchField.val(), (results) => 
        {
            ...
            <div class="row">
                <div class="one-third">
                    <h2 class="search-overlay__section-tittle">General Information</h2>  
                    ${results.generalInfo.length ? '<ul class="link-list min-list">' : '<p>No General Information Matches That Search</p>'}
                        ${results.generalInfo.map(item => `<li><a href="${item.permalink}">${item.title}</a> ${item.postType =='post' ? `by ${item.authorName}` : ''}</li>`).join('')}
                    ${results.generalInfo.length ? '</ul>' : ''}
                </div>
                <div class="one-third">
                    <h2 class="search-overlay__section-tittle">Programs</h2>
                    ...
                    <h2 class="search-overlay__section-tittle">Professors</h2>
                ...
                <div class="one-third">
                    <h2 class="search-overlay__section-tittle">Campuses</h2>
                    ...
                    <h2 class="search-overlay__section-tittle">Events</h2>
